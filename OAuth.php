<?php
/* This is a generic OAuth class, and probably duplicates the funcationality
 * of the one that is part of the one included as part of the Moodle LTI
 * plugin in core. But, this way, I know it's here and don't have to worry
 * about the built in one changing or moving locations.
 * 
 * It also puts all of the classes this this plugin needs in one file so 
 * that I don't include multiple files to get this to work.
 * 
 * It's namespaced so it should stay distinct. 
 */
