...
if ( $ADMIN->fulltree ) {
  ...
  /* Custom Fields */
  $settings->add( new admin_setting_heading( 'filter_ccembed/custom_heading', new lang_string( 'custom_heading', 'filter_ccembed' ), new lang_string( 'custom_heading_help', 'filter_ccembed' ) ) );

  $settings->add( new admin_setting_configtextarea( 'filter_ccembed/custom_fields', new lang_string( 'custom_fields', 'filter_ccembed' ), '', '' ) );
}